...
public class WebSocketClient
{
   ...
   public WebSocketClient(final String uriStr, Listener listener/*, List<BasicNameValuePair> extraHeaders*/)
   {
      try {
         mURI = new URI(uriStr);
      ...
      mThread = new Thread(new Runnable()
      {
         ...
         public void run()
         {
            try {
               ...
               Log.d(LOG_TAG, "WebSocket EOF!", ex);
               mState = State.DISCONNECTED;
         ...
         mHandler.post(new Runnable()
         {
            ...
            public void run()
            {
               try {
                  ...
                  Log.e(LOG_TAG, "Error while disconnecting", ex);
                  mListener.onError(ex);
               }
            }
         });
